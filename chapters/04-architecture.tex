...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.92\textwidth]{figures/diagrams/event-driven-signal-flow}
    \caption{Event-driven signal flow across local scene components and multiplayer synchronization paths}
    \label{fig:event-driven-signal-flow}
\end{figure}
