...
\end{lstlisting}
% TODO: Add plugin/source links for listed addons.
% TODO: GD-Sync link: <ADD_LINK>
% TODO: ToastParty link: <ADD_LINK>
% TODO: Logger link: <ADD_LINK>
...
GDSync provides high-level networking abstractions. The decision process for adopting GDSync over alternatives is documented in Section~\ref{subsec:gdsync-selection}; this section focuses on implementation details.
...
% TODO: Add Logger plugin repository/documentation link: <ADD_LINK>
...
% TODO: Add VarTree plugin repository/documentation link: <ADD_LINK>
