...
\begin{itemize}
    ...
    \item public buffers representing thread-local storage (OpenMP)
    \item Card movement between shared container and public buffers representing memory access patterns
