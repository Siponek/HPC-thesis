...
% TODO: [Artifact] Development timeline figure (Phases 1--5).
% TODO: [Purpose] Summarize iteration cadence and decision points that affected architecture/tooling.
% TODO: [Source Inputs] Phase breakdown below; technology decision pivots from Section~\ref{sec:technology-selection}; multiplayer issue milestones from Chapter~\ref{ch:problems}.
% TODO: [Placement] Directly before Phase 1 narrative.
% TODO: [Done Criteria] Include weeks, milestones, and at least three explicit decision pivots (engine/tooling/network/patch-related).
% TODO: [Cross-refs] Sections~\ref{subsec:tool-eval-process} and~\ref{subsec:toolchain-summary}; Chapter~\ref{ch:problems}, Section~\ref{subsec:web-patch-case-study}.
