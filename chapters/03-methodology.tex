...
\begin{itemize}
    \item Primary: Chrome 145+ (Windows, Linux)
    \item Secondary: Firefox 148+ (Windows, Linux)
    \item Tertiary: Edge 145+ (Linux)
