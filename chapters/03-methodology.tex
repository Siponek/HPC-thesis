...
\begin{itemize}
    ...
    \item Players must have public buffers (thread-local storage)
...
\begin{itemize}
    ...
    \item Confetti or celebration effects upon game completion
          % TODO: Add figure/screenshot showing the completion-state celebration effect (confetti) and annotate which UI elements are highlighted.
\end{itemize}
...
\begin{itemize}
    \item \textbf{ToastParty (Godot plugin)}: non-blocking UI event popups; improved usability feedback during multiplayer sessions.
    \item \textbf{VarTree (Godot plugin)}: runtime inspection/modification of sync variables; reduced debugging turnaround.
    ...
    \item \textbf{Python/aiohttp relay server}: browser-compatible signaling/relay backend for HTTP/SSE transport.
    \item \textbf{Ruff}: linting and style checks for Python server/scripts; improved maintainability and consistency.
    \item \textbf{justfile}: repeatable task automation for build/test/maintenance workflows.
    \item \textbf{mkcert}: trusted local TLS certificates for secure browser multiplayer testing.
    \item \textbf{Chocolatey}: standardized Windows package setup, reducing environment variability.
    \item \textbf{const\_generator}: generated constants to reduce manual duplication and config drift.
    \item \textbf{Git + GitHub}: version control, issue tracking, and collaborative documentation supporting reproducible research development.
\end{itemize}

% TODO: Add verification links for external plugins/tools listed above.
% TODO: Godot Engine link: <ADD_LINK>
% TODO: GDSync link: <ADD_LINK>
% TODO: ToastParty link: <ADD_LINK>
% TODO: VarTree link: <ADD_LINK>
% TODO: Logger plugin/custom logger link: <ADD_LINK>
% TODO: Python link: <ADD_LINK>
% TODO: aiohttp link: <ADD_LINK>
% TODO: Ruff link: <ADD_LINK>
% TODO: justfile/just link: <ADD_LINK>
% TODO: mkcert link: <ADD_LINK>
% TODO: Chocolatey link: <ADD_LINK>
% TODO: const_generator link: <ADD_LINK>
% TODO: Git link: <ADD_LINK>
% TODO: GitHub link: <ADD_LINK>
...
% TODO: Add timeline figure (Phases 1--5, weeks, and key milestones) to summarize the iterative development process.
...
The educational tool's success was evaluated across multiple dimensions:
...
\begin{enumerate}
    ...
    \item \textbf{Educational Effectiveness}: Preliminary conceptual understanding and engagement indicators (informal evaluation scope)
\end{enumerate}
