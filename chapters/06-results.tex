...
\begin{figure}[p]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=0.3\textwidth]{resources/images/singleplayer/single-player-options.png}
...
\begin{figure}[p]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=0.4\textwidth]{resources/images/multiplayer/multiplayer-victory.png}
