...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        ...
        \caption{Private buffer interaction}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
...
\begin{enumerate}
    ...
    \item \textbf{Shared and private workspaces have different roles.}
          Evidence: players recognized shared container access versus private buffer semantics in multiplayer mode.
    ...
    \item \textbf{Visibility/synchronization rules shape collaboration behavior.}
          Evidence: hidden private-buffer state and authoritative synchronization influenced player strategy and timing.
\end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{7/8} identified multiplayer mode as shared-memory collaboration with private buffers (OpenMP-style analogy)
