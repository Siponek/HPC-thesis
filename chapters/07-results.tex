...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        ...
        \caption{public buffer interaction}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
    ...
    \end{subfigure}
    \caption{Implemented UX flow screenshots, including the playful evasive menu microinteraction and core single-player interaction states}
    \label{fig:results-screenshot-montage}
\end{figure}

% TODO: Extend this montage with multiplayer lobby/identity-indicator frames and completion/victory frame when those screenshots are exported.
