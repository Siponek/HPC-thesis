...
\end{itemize}
% TODO: [Artifact] Screenshot montage of implemented UX flow.
% TODO: [Purpose] Provide visual evidence for feature completeness and interaction context.
% TODO: [Source Inputs] Main menu, single-player board, multiplayer lobby, in-game shared/private buffers, completion/victory view, and one frame with player identity indicators (color/icon) in lobby and game.
% TODO: [Placement] Immediately after this feature list.
% TODO: [Done Criteria] Include at least six annotated frames, including one frame showing the evasive rotating menu option interaction.
% TODO: [Cross-refs] Chapter~\ref{ch:architecture}, Sections~\ref{subsec:scene-lifecycle} and~\ref{subsec:ui-layering}.
...
\begin{itemize}
    \item \textbf{Context}: Small groups (2--4 players) with minimal upfront instructions.
...
Educational evaluation fo the tool itself is in the scope of this thesis, preliminary indicators suggest educational value:
