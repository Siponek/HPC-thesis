...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \hfill
    % TODO: Export and add multiplayer lobby screenshot
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \fbox{\parbox[c][6cm][c]{\dimexpr\textwidth-2\fboxsep-2\fboxrule}{%
                \centering\textit{Multiplayer lobby placeholder}\\[0.5em]
                \small Host is marked with a distinct color;\\
                the local player is highlighted in bright green\\
                for self-identification}}
        \caption{Multiplayer lobby (screenshot pending)}
    \end{subfigure}
    \caption{Victory summary and multiplayer lobby with color-coded player identification (screenshots pending)}
