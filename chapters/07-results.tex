...
\end{itemize}
% TODO: Add screenshot montage of the implemented system (main menu, single-player board, multiplayer lobby, in-game shared/private buffers, victory screen).
...
% TODO: Add performance plots (FPS vs. card count, memory usage vs. game state, and browser comparison chart) to complement the tables.
...
% TODO: Add usability visualization (questionnaire Likert summary chart and participant feedback category breakdown).
