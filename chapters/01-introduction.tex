...
These physical activities were highly effective at cThese physical activities were highly effective at conveying parallel computing concepts in a tangible, memorable way. However, they faced significant limitations: scalability (limited by classroom size), repeatability (difficult to reproduce), and accessibility (requires physical presence).
...
\item \textbf{HTTP/SSE Relay Server}: Custom server for real-time web-based multiplayer communication game development and web-based multiplayer architecture:
