...
\begin{itemize}
    ...
    \item \textbf{OpenMP Simulation}: Multiple students work collaboratively at a shared desk with all cards visible in a common container, using public buffer areas for local sorting—demonstrating shared memory parallelism with thread-local storage
\end{itemize}
