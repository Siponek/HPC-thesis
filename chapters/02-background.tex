...
% TODO: Add conceptual overview figure for this chapter (HPC fundamentals + serious games + web multiplayer context) to visually frame the literature landscape.
...
% TODO: Add comparison diagram (Client-Server vs Peer-to-Peer vs HTTP/SSE relay) with pros/cons and selected approach highlight.
