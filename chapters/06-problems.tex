...
\begin{itemize}
    \item Browser runtime constraints and export behavior invalidated assumptions from local prototype networking paths.
...
% TODO: [Artifact] Before/after architecture diff figure (prototype path vs patched web path).
% TODO: [Purpose] Show exactly what was intercepted/replaced and what remained unchanged at gameplay-manager level.
% TODO: [Source Inputs] scenes/Multiplayer/GDSyncWebPatch/gdsync_web_patch.gd; scenes/Multiplayer/GDSyncWebPatch/local_server_signaling.gd; scenes/Multiplayer/GDSyncWebPatch/signaling_client.gd.
% TODO: [Placement] First figure in this subsection.
% TODO: [Done Criteria] Must identify replaced local-server component, preserved manager API surface, and browser-compatible relay path.
% TODO: [Cross-refs] Chapter~\ref{ch:architecture}, Section~\ref{subsec:gdsync-integration}.

% TODO: [Artifact] Packet/event-path sequence diagram for the patched flow.
% TODO: [Purpose] Explain request lifecycle from gameplay event to signaling relay and synchronized client update.
% TODO: [Source Inputs] local_server_signaling.gd process loop and signaling_client.gd SSE/HTTP event handling.
% TODO: [Placement] After architecture diff figure.
% TODO: [Done Criteria] Include prototype-era call intent, interception point, server relay, and returned event propagation.
% TODO: [Cross-refs] Chapter~\ref{ch:implementation}, Section~\ref{subsec:lobby-system}.

% TODO: [Artifact] "Cost of patching" summary table.
% TODO: [Purpose] Make trade-offs explicit (complexity, maintenance, and fork dependency).
% TODO: [Source Inputs] Patch maintenance notes, fork/PR status, debugging effort observations.
% TODO: [Placement] End of this subsection.
% TODO: [Done Criteria] At minimum include extra complexity, maintenance burden, and temporary fork dependency with one mitigation each.
% TODO: [Cross-refs] Chapter~\ref{ch:methodology}, Section~\ref{subsec:toolchain-summary}.
...
In multiplayer mode (OpenMP simulation), different players should see different cards in private buffers (simulating thread-private data), but maintaining this selective visibility while synchronizing the shared container was complex.
