...
\textbf{Challenge:} While Godot Engine proved to be a good choice overall, several limitations became apparent during development:
...
\textbf{Impact:} Development time increased due to the need to:
\begin{itemize}
