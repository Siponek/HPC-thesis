...
\begin{enumerate}
    ...
    \item Configure game parameters in the options dialog:
          \begin{itemize}
              ...
              \item \textbf{Buffer slot count}: number of public buffer positions
...
\paragraph{public buffers (Thread-Local Storage):}
\begin{itemize}
    \item Each player has public buffer slots visible only to themselves
...
\begin{itemize}
    ...
    \item Facilitate post-gameplay discussion connecting game mechanics to parallel programming:
          \begin{itemize}
              ...
              \item public buffers $\leftrightarrow$ thread-local / private variables
