...
\begin{itemize}
    ...
    \item \texttt{sync\_card\_entered\_buffer(value, player\_id)} --- Card enters local buffer
...
\begin{lstlisting}[style={gdscript}, caption={GDSync function exposure (actual API)}]
