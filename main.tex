...
\lstdefinestyle{gdscript}{
    keywords={func, var, const, if, elif, else, for, while, match, return,
        pass, break, continue, class, extends, signal, enum, export,
        onready, static, null, true, false, self, and, or, not, in,
        await, yield},
